...
#include "F:/tensorflow-r1.2/tensorflow-r1.2/tensorflow/contrib/cmake/build/tensorflow/cc/ops/array_ops.h"
...
PlaceholderV2::PlaceholderV2(const ::tensorflow::Scope& scope, DataType dtype,
                             PartialTensorShape shape) {
  if (!scope.ok()) return;
  ::tensorflow::Node* ret;
