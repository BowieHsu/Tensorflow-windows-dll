...
#ifndef F__TENSORFLOW_R____TENSORFLOW_R____TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_LOOKUP_OPS_H_
#define F__TENSORFLOW_R____TENSORFLOW_R____TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_LOOKUP_OPS_H_
...
class HashTableV2 {
 public:
  /// Optional attribute setters for HashTableV2
  struct Attrs {
  ...
  HashTableV2(const ::tensorflow::Scope& scope, DataType key_dtype, DataType
            value_dtype);
  HashTableV2(const ::tensorflow::Scope& scope, DataType key_dtype, DataType
            value_dtype, const HashTableV2::Attrs& attrs);
...
class InitializeTableFromTextFileV2 {
 public:
  /// Optional attribute setters for InitializeTableFromTextFileV2
  struct Attrs {
  ...
  InitializeTableFromTextFileV2(const ::tensorflow::Scope& scope,
  ...
  InitializeTableFromTextFileV2(const ::tensorflow::Scope& scope,
                              ...
                              InitializeTableFromTextFileV2::Attrs& attrs);
...
class InitializeTableV2 {
 public:
  InitializeTableV2(const ::tensorflow::Scope& scope, ::tensorflow::Input
...
class LookupTableExportV2 {
 public:
  LookupTableExportV2(const ::tensorflow::Scope& scope, ::tensorflow::Input
                    table_handle, DataType Tkeys, DataType Tvalues);
...
class LookupTableFindV2 {
 public:
  LookupTableFindV2(const ::tensorflow::Scope& scope, ::tensorflow::Input
                  table_handle, ::tensorflow::Input keys, ::tensorflow::Input
                  default_value);
...
class LookupTableImportV2 {
 public:
  LookupTableImportV2(const ::tensorflow::Scope& scope, ::tensorflow::Input
                    table_handle, ::tensorflow::Input keys, ::tensorflow::Input
                    values);
  operator ::tensorflow::Operation() const { return operation; }
...
class LookupTableInsertV2 {
 public:
  LookupTableInsertV2(const ::tensorflow::Scope& scope, ::tensorflow::Input
                    table_handle, ::tensorflow::Input keys, ::tensorflow::Input
                    values);
  operator ::tensorflow::Operation() const { return operation; }
...
class LookupTableSizeV2 {
 public:
  LookupTableSizeV2(const ::tensorflow::Scope& scope, ::tensorflow::Input
                  table_handle);
...
class MutableDenseHashTableV2 {
 public:
  /// Optional attribute setters for MutableDenseHashTableV2
  struct Attrs {
    /// If non-empty, this table is placed in the given container.
    /// Otherwise, a default container is used.
    ///
    ...
    ///
    /// Defaults to []
    Attrs ValueShape(PartialTensorShape x) {
      Attrs ret = *this;
      ret.value_shape_ = x;
      return ret;
    }
  ...
  MutableDenseHashTableV2(const ::tensorflow::Scope& scope, ::tensorflow::Input
                        empty_key, DataType value_dtype);
  MutableDenseHashTableV2(const ::tensorflow::Scope& scope, ::tensorflow::Input
                        empty_key, DataType value_dtype, const
                        MutableDenseHashTableV2::Attrs& attrs);
  operator ::tensorflow::Output() const { return table_handle; }
  operator ::tensorflow::Input() const { return table_handle; }
  ::tensorflow::Node* node() const { return table_handle.node(); }
...
class MutableHashTableOfTensorsV2 {
 public:
  /// Optional attribute setters for MutableHashTableOfTensorsV2
  struct Attrs {
    /// If non-empty, this table is placed in the given container.
    /// Otherwise, a default container is used.
    ///
  ...
  MutableHashTableOfTensorsV2(const ::tensorflow::Scope& scope, DataType
                            key_dtype, DataType value_dtype);
  MutableHashTableOfTensorsV2(const ::tensorflow::Scope& scope, DataType
                            key_dtype, DataType value_dtype, const
                            MutableHashTableOfTensorsV2::Attrs& attrs);
  operator ::tensorflow::Output() const { return table_handle; }
  operator ::tensorflow::Input() const { return table_handle; }
  ::tensorflow::Node* node() const { return table_handle.node(); }
...
class MutableHashTableV2 {
 public:
  /// Optional attribute setters for MutableHashTableV2
  struct Attrs {
    /// If non-empty, this table is placed in the given container.
    /// Otherwise, a default container is used.
    ///
  ...
  MutableHashTableV2(const ::tensorflow::Scope& scope, DataType key_dtype,
                   DataType value_dtype);
  MutableHashTableV2(const ::tensorflow::Scope& scope, DataType key_dtype,
                   DataType value_dtype, const MutableHashTableV2::Attrs&
                   attrs);
  operator ::tensorflow::Output() const { return table_handle; }
  operator ::tensorflow::Input() const { return table_handle; }
  ::tensorflow::Node* node() const { return table_handle.node(); }
...
#endif  // F__TENSORFLOW_R____TENSORFLOW_R____TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_LOOKUP_OPS_H_
