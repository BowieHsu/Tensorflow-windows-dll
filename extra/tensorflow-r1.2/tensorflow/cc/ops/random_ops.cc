...
#include "F:/tensorflow-r1.2/tensorflow-r1.2/tensorflow/contrib/cmake/build/tensorflow/cc/ops/random_ops.h"
...
RandomPoisson::RandomPoisson(const ::tensorflow::Scope& scope,
                             ::tensorflow::Input shape, ::tensorflow::Input
                             rate, const RandomPoisson::Attrs& attrs) {
  if (!scope.ok()) return;
  auto _shape = ::tensorflow::ops::AsNodeOut(scope, shape);
  if (!scope.ok()) return;
...
RandomPoisson::RandomPoisson(const ::tensorflow::Scope& scope,
                             ::tensorflow::Input shape, ::tensorflow::Input
                             rate)
  : RandomPoisson(scope, shape, rate, RandomPoisson::Attrs()) {}
