...
const ::google::protobuf::Descriptor* ResourceHandle_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  ResourceHandle_reflection_ = NULL;
...
void protobuf_AssignDesc_tensorflow_2fcore_2fframework_2fresource_5fhandle_2eproto() {
  ...
  ResourceHandle_descriptor_ = file->message_type(0);
  static const int ResourceHandle_offsets_[5] = {
  ...
  ResourceHandle_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ResourceHandle_descriptor_,
      ResourceHandle::internal_default_instance(),
      ResourceHandle_offsets_,
      -1,
      -1,
      -1,
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      ResourceHandle_descriptor_, ResourceHandle::internal_default_instance());
}

}  // namespace

void protobuf_ShutdownFile_tensorflow_2fcore_2fframework_2fresource_5fhandle_2eproto() {
  ResourceHandle_default_instance_.Shutdown();
  delete ResourceHandle_reflection_;
}
...
void protobuf_InitDefaults_tensorflow_2fcore_2fframework_2fresource_5fhandle_2eproto_impl() {
  ...
  ResourceHandle_default_instance_.DefaultConstruct();
  ResourceHandle_default_instance_.get_mutable()->InitAsDefaultInstance();
}
...
void protobuf_AddDesc_tensorflow_2fcore_2fframework_2fresource_5fhandle_2eproto_impl() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "B\023ResourceHandleProtoP\001\370\001\001b\006proto3", 234);
...
const ::google::protobuf::Descriptor* ResourceHandle::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return ResourceHandle_descriptor_;
}
...
::google::protobuf::internal::ExplicitlyConstructed<ResourceHandle> ResourceHandle_default_instance_;
...
void ResourceHandle::UnsafeMergeFrom(const ResourceHandle& from) {
...
::google::protobuf::Metadata ResourceHandle::GetMetadata() const {
  ...
  metadata.descriptor = ResourceHandle_descriptor_;
  metadata.reflection = ResourceHandle_reflection_;
  return metadata;
}
