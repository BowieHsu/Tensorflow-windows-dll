...
void protobuf_AssignDesc_tensorflow_2fcore_2fframework_2fstep_5fstats_2eproto() {
  ...
  static const int AllocatorMemoryUsed_offsets_[4] = {
...
void protobuf_AddDesc_tensorflow_2fcore_2fframework_2fstep_5fstats_2eproto_impl() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "tosP\001\370\001\001b\006proto3", 1216);
...
void AllocatorMemoryUsed::SharedCtor() {
  ...
  ::memset(&total_bytes_, 0, reinterpret_cast<char*>(&live_bytes_) -
    reinterpret_cast<char*>(&total_bytes_) + sizeof(live_bytes_));
  _cached_size_ = 0;
}
