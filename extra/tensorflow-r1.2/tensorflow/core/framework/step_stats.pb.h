...
class MemoryStats : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.MemoryStats) */ {
 public:
  ...
  static const MemoryStats* internal_default_instance();
  ...
  inline MemoryStats* New() const { return New(NULL); }

  MemoryStats* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  void UnsafeMergeFrom(const MemoryStats& from);
  protected:
...
extern ::google::protobuf::internal::ExplicitlyConstructed<MemoryStats> MemoryStats_default_instance_;
