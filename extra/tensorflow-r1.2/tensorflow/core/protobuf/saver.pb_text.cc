...
void AppendProtoDebugString(
  ...
  if (msg.version() != 0) {
    o->AppendEnumName("version", ::tensorflow::EnumName_SaverDef_CheckpointFormatVersion(msg.version()));
  }
}
